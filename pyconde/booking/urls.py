...
#    url(r'^$', views.book, name='booking-book'),
                       ...
                       url(r'^'+settings.OBSCURE+'/bookreport$', views.secretbookreport,name='booking-secretbookreport'),
                       url(r'^'+settings.OBSCURE+'/spendreport$', views.secretspending,name='spending-secretbookreport'),
